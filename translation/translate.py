...
tf.app.flags.DEFINE_integer("from_vocab_size", 4000, "English vocabulary size.")
tf.app.flags.DEFINE_integer("to_vocab_size", 4000, "French vocabulary size.")
      ...
      if current_step % FLAGS.steps_per_checkpoint == 0:
        ...
        if perplexityRound < 9.9:
          if not _lowestPerplexity:
            ...
            #print(str(c) + "---List is empty")

          if perplexityRound == _lowestPerplexity[0]:
            #print(str(c) + "---Checking if perplexityRound is equal to lowest")
            if _lowestPerplexity[1] > 9:
             ...
             #print(str(c) + "---Checking if current perplexity is lower")
             if perplexityRound < _lowestPerplexity[0]:
                _lowestPerplexity[0] = perplexityRound
                _lowestPerplexity[1] = 1

          #c = c + 1
          print("Lowest Perplexity List--"+str(_lowestPerplexity))
